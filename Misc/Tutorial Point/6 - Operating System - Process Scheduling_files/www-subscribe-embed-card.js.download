...
;var ua=y(),H=[];function I(a){throw Error("Bad hint"+(a?": "+a:""));}
...
var va=/^(\/[a-zA-Z0-9_\-]+)+$/,wa=[/\/amp\//,/\/amp$/,/^\/amp$/],xa=/^[a-zA-Z0-9\-_\.,!]+$/,ya=/^gapi\.loaded_[0-9]+$/,za=/^[a-zA-Z0-9,._-]+$/;function Aa(a,b,c,d){var e=a.split(";"),f=e.shift(),g=ua[f],l=null;g?l=g(e,b,c,d):I("no hint processor for: "+f);l||I("failed to generate load url");b=l;c=b.match(Ba);(d=b.match(Ca))&&1===d.length&&Da.test(b)&&c&&1===c.length||I("failed sanity: "+a);return l}
function Ea(a,b,c,d){function e(a){return encodeURIComponent(a).replace(/%2C/g,",")}
a=Fa(a);ya.test(c)||I("invalid_callback");b=Ga(b);d=d&&d.length?Ga(d):null;return[encodeURIComponent(a.pathPrefix).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.a?"/am="+e(a.a):"",a.c?"/rs="+e(a.c):"",a.f?"/t="+e(a.f):"","/cb=",e(c)].join("")}
function Fa(a){"/"!==a.charAt(0)&&I("relative path");for(var b=a.substring(1).split("/"),c=[];b.length;){a=b.shift();if(!a.length||0==a.indexOf("."))I("empty/relative directory");else if(0<a.indexOf("=")){b.unshift(a);break}c.push(a)}a={};for(var d=0,e=b.length;d<e;++d){var f=b[d].split("="),g=decodeURIComponent(f[0]),l=decodeURIComponent(f[1]);2==f.length&&g&&l&&(a[g]=a[g]||l)}b="/"+c.join("/");va.test(b)||I("invalid_prefix");c=0;for(d=wa.length;c<d;++c)wa[c].test(b)&&I("invalid_prefix");c=K(a,"k",
...
function K(a,b,c){a=a[b];!a&&c&&I("missing: "+b);if(a){if(xa.test(a))return a;I("invalid: "+b)}return null}
var Da=/^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,Ca=/\/cb=/g,Ba=/\/\//g;function Ha(){var a=qa();if(!a)throw Error("Bad hint");return a}
ua.m=function(a,b,c,d){(a=a[0])||I("missing_hint");return"https://apis.google.com"+Ea(a,b,c,d)};
...
function Ka(){var a=A.nonce;if(void 0!==a)return a&&a===String(a)&&a.match(Ia)?a:A.nonce=null;var b=x(A,"us",[]);if(!b||!b.length)return A.nonce=null;for(var c=w.getElementsByTagName(L),d=0,e=c.length;d<e;++d){var f=c[d];if(f.src&&(a=String(f.nonce||f.getAttribute("nonce")||"")||null)){for(var g=0,l=b.length;g<l&&b[g]!==f.src;++g);if(g!==l&&a&&a===String(a)&&a.match(Ia))return A.nonce=a}}return null}
...
function M(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Na(a,c);var d=a?a.split(":"):[],e=c.h||Ha(),f=x(A,"ah",y());if(f["::"]&&d.length){for(var g=[],l=null;l=d.shift();){var n=l.split(".");n=f[l]||f[n[1]&&"ns:"+n[0]||""]||e;var C=g.length&&g[g.length-1]||null,D=C;C&&C.hint==n||(D={hint:n,b:[]},g.push(D));D.b.push(l)}var J=g.length;if(1<J){var E=c.callback;E&&(c.callback=function(){0==--J&&E()})}for(;d=g.shift();)Qa(d.b,c,d.hint)}else Qa(d||[],c,e)}
function Qa(a,b,c){function d(a,b){if(J)return 0;t.clearTimeout(D);E.push.apply(E,q);var d=((z||{}).config||{}).update;d?d(f):f&&x(A,"cu",[]).push(f);if(b){G("me0",a,R);try{Oa(b,c,C)}finally{G("me1",a,R)}}return 1}
a=pa(a)||[];var e=b.callback,f=b.config,g=b.timeout,l=b.ontimeout,n=b.onerror,C=void 0;"function"==typeof n&&(C=n);var D=null,J=!1;if(g&&!l||!g&&l)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";n=x(B(c),"r",[]).sort();var E=x(B(c),"L",[]).sort(),R=[].concat(n);0<g&&(D=t.setTimeout(function(){J=!0;l()},g));
...
;var N=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{},O=["yt","config_"],P=h;O[0]in P||!P.execScript||P.execScript("var "+O[0]);for(var Q;O.length&&(Q=O.shift());)O.length||void 0===N?P[Q]&&P[Q]!==Object.prototype[Q]?P=P[Q]:P=P[Q]={}:P[Q]=N;function Wa(){return aa("gapi.iframes.getContext")()}
